...
const Overlay = (props) => {
    return (
        <div className={`min-h-[670px] after:absolute after:w-full after:h-[100px] after:bg-black after:blur-lg pointer-events-none after:-bottom-[50px] after:left-0 before:absolute ms:min-h-[400px] before:w-[500px] before:h-[500px] before:rounded-full before:bg-y before:opacity-[.14] before:blur-[3rem] overflow-hidden before:-left-[145px] before:-top-[95px] ${props.position ? 'relative' : 'absolute top-0 left-0 w-full'}`}>
